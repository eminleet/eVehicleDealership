    ...
    public static class ModelBuilderExtension
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KorisnikUloga>().HasData(
                new KorisnikUloga { KorisnikUlogaId = 1, KorisnikId = 1, UlogaId = 1, DatumIzmjene = new DateTime(2020, 5, 1) },
                new KorisnikUloga { KorisnikUlogaId = 2, KorisnikId = 2, UlogaId = 2, DatumIzmjene = new DateTime(2020, 5, 1) }
            );
            ...
            new SlikaVozila { SlikaVozilaId = 9, VoziloId = 3, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo3_4.png")) },

            new SlikaVozila { SlikaVozilaId = 10, VoziloId = 4, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo4_1.png")) }
            );

            //modelBuilder.Entity<SlikaVozila>().HasData(
            //    new SlikaVozila { SlikaVozilaId = 11, VoziloId = 4, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo4_2.png")) },

            //    new SlikaVozila { SlikaVozilaId = 12, VoziloId = 5, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo5_1.png")) },
            //    new SlikaVozila { SlikaVozilaId = 13, VoziloId = 5, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo5_2.png")) },
            //    new SlikaVozila { SlikaVozilaId = 14, VoziloId = 5, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo5_3.png")) },

            //    new SlikaVozila { SlikaVozilaId = 15, VoziloId = 6, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo6_1.png")) },

            //);

            //modelBuilder.Entity<SlikaVozila>().HasData(
            //    new SlikaVozila { SlikaVozilaId = 16, VoziloId = 7, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo7_1.jpg")) }
            //    new SlikaVozila { SlikaVozilaId = 17, VoziloId = 7, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo7_2.png")) },

            //    new SlikaVozila { SlikaVozilaId = 18, VoziloId = 8, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo8_1.jpg")) },

            //    new SlikaVozila { SlikaVozilaId = 19, VoziloId = 9, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo9_1.png")) },
            //    new SlikaVozila { SlikaVozilaId = 20, VoziloId = 9, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo9_2.png")) },
            //);

            //modelBuilder.Entity<SlikaVozila>().HasData(
            //    new SlikaVozila { SlikaVozilaId = 21, VoziloId = 9, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo9_3.png")) },
            //    new SlikaVozila { SlikaVozilaId = 22, VoziloId = 9, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo9_4.png")) },

            //    new SlikaVozila { SlikaVozilaId = 23, VoziloId = 10, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo10_1.png")) },
            //    new SlikaVozila { SlikaVozilaId = 24, VoziloId = 10, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo10_2.png")) }

            //    new SlikaVozila { SlikaVozilaId = 25, VoziloId = 11, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo11_1.png")) },
            //);

            //modelBuilder.Entity<SlikaVozila>().HasData(
            //    new SlikaVozila { SlikaVozilaId = 26, VoziloId = 12, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo12_1.png")) },
            //    new SlikaVozila { SlikaVozilaId = 27, VoziloId = 12, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo12_2.png")) },

            //    new SlikaVozila { SlikaVozilaId = 28, VoziloId = 13, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo13_1.png")) },
            //    new SlikaVozila { SlikaVozilaId = 29, VoziloId = 13, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo13_2.png")) },
            //    new SlikaVozila { SlikaVozilaId = 30, VoziloId = 13, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo13_3.png")) },
            //);

            //modelBuilder.Entity<SlikaVozila>().HasData(
            //    new SlikaVozila { SlikaVozilaId = 31, VoziloId = 14, Slika = File.ReadAllBytes(Path.Combine(Directory.GetCurrentDirectory(), "SeedImages/Vozilo14_1.png")) }
            //);
